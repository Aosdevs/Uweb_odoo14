odoo.define('spiffy_theme_backend.ListRendererInherit', function (require) {
    ...
    var biz_listrenderer = ListRenderer.include({
        ...
        split_view_controller: function (record_id) {
          ...
          var currentController = AdaptView.getCurrentController();
          
          var params = {
            resModel: currentController.widget.modelName,
            views: currentController.widget.actionViews,
            context: currentController.widget.controlPanelProps.action.context,
          };
          var options = {
            actionId: currentController.widget.controlPanelProps.action.id,
            loadActionMenus: currentController.widget.hasActionMenus,
            loadIrFilters: currentController.widget.withControlPanel,
          };
        ...
        biz_form_controller: function(record_id,ListController,AdaptView,currentController,params,options){
          ...
          var fields_view_def = this.loadViews(params.resModel, params.context, [[false, 'form']], options);
          var rec_id = ListController.model.get(record_id, {raw: true});

          return fields_view_def.then(function (viewInfo) {
              viewInfo['form'].toolbar = ListController.toolbarActions
    ...
    patch(components.ActionMenus, "spiffy_theme_backend_ent.ListRendererInherit", {
