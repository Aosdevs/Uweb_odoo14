    ...
    var DentalChartView = AbstractAction.extend({
        ...
        init: function (parent, options) {
            ...
            self.patient_history().then(function (res) {
                console.log('before categories 1', self)
                console.log('before categories 1', other_patient_history)
                ...
                console.log('before categories 2')
        ...
        write_patient_history: function (self_var, res) {
            ...
            _.each(res, function (each_operation) {
                ...
                if (each_operation['tooth_id']) {
                    ...
                    console.log("Prgogresss  111",each_operation);
                    if(each_operation['surface'] !== false){
            ...
            selected_treatment = '';
            console.log("Selected treatment final" , selected_treatment)
        },
                ...
                for (var op = 1; op <= operation_id; op++) {
                    ...
                    if (op_id) {
                        ...
                        if (completion_date != 'undefined' && completion_date != 'false') {
                            console.log("000000",completion_date);
