...
class ResConfigSettings(models.TransientModel):
    ...
    event_id = fields.Text(string='Event name')
    event_token = fields.Text(string='Event Token')
    ...
    def get_values(self):
        ...
        event_id = params.get_param('event_id', default=False)
        event_token = params.get_param('event_token', default=False)
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param("event_id", self.event_id)
        self.env['ir.config_parameter'].sudo().set_param("event_token", self.event_token)
